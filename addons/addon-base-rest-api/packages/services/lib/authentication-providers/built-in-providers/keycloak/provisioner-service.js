...
class ProvisionerService extends Service {
  ...
  async provision({ providerTypeConfig, providerConfig, action }) {
    ...
    this.log.info('provision mingtong step 1 providerConfig', providerConfig);
    this.log.info('provision mingtong step 2 providerTypeConfig', providerTypeConfig);
    ...
    this.log.info('mingtong step 3 existingProviderConfig', existingProviderConfig);
    ...
    this.log.info('provision mingtong step 6. providerConfig', providerConfig);
