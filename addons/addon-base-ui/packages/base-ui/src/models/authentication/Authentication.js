  ...
  .actions(self => ({
    ...
    async getIdToken() {
      ...
      if (authCode) {
        ...
        console.log('getIdToken mingtong step 1, self.selectedAuthenticationProvider', self.selectedAuthenticationProvider);
        console.log('getIdToken mingtong step 1, self.selectedAuthenticationProvider.providerConfigId', self.selectedAuthenticationProvider.providerConfigId);
